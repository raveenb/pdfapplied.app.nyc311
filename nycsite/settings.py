# Django settings for nycsite project.
...
SECRET_KEY = 'wu5s2zl63^yi2bw4)abf)9z_!ipjn9&amp;c0!**g5qobrcefa8x1w'
...
ROOT_URLCONF = 'nycsite.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'nycsite.wsgi.application'
